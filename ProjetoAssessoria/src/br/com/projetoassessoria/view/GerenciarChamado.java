...
public class GerenciarChamado extends JFrame {
	...
	public GerenciarChamado() {
		...
		lblNomePessoa.setForeground(new Color(255, 255, 255));
		...
		lblDataAbertura.setForeground(Color.WHITE);
		lblDataAbertura.setBounds(300, 52, 100, 14);
		...
		lblStatusChamado.setForeground(Color.WHITE);
		lblStatusChamado.setBounds(10, 93, 120, 14);
		contentPane.add(lblStatusChamado);
		
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon(GerenciarChamado.class.getResource("/vivo-op.png")));
		...
		btnAbrirGrafico.setBounds(528, 226, 89, 23);
