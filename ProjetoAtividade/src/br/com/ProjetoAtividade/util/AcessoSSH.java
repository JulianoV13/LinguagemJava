 ...
 * Para realizar esta operação foi necessário a utilização de uma biblioteca chamada, 
 * jsch(Java Security Channel). Esta biblioteca foi baixada do site: http://www.jcraft.com/jsch/
 * */
